...
namespace Loja.Ecommerce.Tests
{
    public class UnitTest1
    {
        ...
        //Teste salvar
        [Theory]
        [InlineData("PROD0001", "Televisão 32 polegadas", "Televisão 32 polegadas", "Sony", "test image", "Televisões", 526)]
        ...
        public void Save(string sku, string name, string description, string brand, string imageUrl, string category, decimal price)
        {
